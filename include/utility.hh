...
namespace ds {
    ...
    /// @return 二进制的term, 此指针调用方负责free，如果长度超过限制，则返回nullptr
    ...
    /// @return 文本形式的term, 此指针调用方负责free，如果长度超过限制，则返回nullptr
    ...
    /// @return 结果term_t对象的指针, 此指针调用方负责free，如果长度超过限制，则返回nullptr
    ...
    /// @return 二进制的rule, 此指针调用方负责free，如果长度超过限制，则返回nullptr
    ...
    /// @return 文本形式的rule, 此指针调用方负责free，如果长度超过限制，则返回nullptr
    ...
    /// @return 结果rule_t对象的指针, 此指针调用方负责free，如果长度超过限制，则返回nullptr
